    ...
    <MePageBasePanel>
      ...
      <template #main-content>
        ...
        >
          ...
          <el-table-column prop="meta.title" label="按钮名称" width="200" />
          <el-table-column prop="path" label="页面路由" width="200" />
          <el-table-column prop="component" label="组件路由" width="200" />
...
import SaveInfoForm from "@/views/system/permission/SaveInfoForm.vue";
import AdvancedQuery from "@/views/system/permission/AdvancedQuery.vue";
