<template>
  <el-dialog v-model="dialogShow" :title="title">
    <el-form :ref="formRef" :model="formData" :rules="rules" label-width="80px">
      ...
      <el-form-item label="效果设置" prop="type">
      ...
      <el-form-item prop="mobileShow" label="移动端展示" width="68">
        <el-switch
          ...
          @change="
            () => {
              handleMobileShowChange(mobileShow);
            }
          "
        />
      </el-form-item>

      <el-form-item v-if="formData.type == '图片'" label="图片" prop="image">
      ...
      <el-form-item
        ...
        prop="fontColor"
      >
        <el-color-picker v-model="formData.fontColor" />
      </el-form-item>
      <el-form-item
        v-if="formData.type == '自定义'"
        label="背景颜色"
...
import {
  ...
  getEditApi,
  getShowApi
} from "@/api/product/productTag/productTagInfoApi";
...
//改变状态status
const handleMobileShowChange = async (mobileShow: any) => {
  // 发起编辑状态
  if (mobileShow == 0) {
