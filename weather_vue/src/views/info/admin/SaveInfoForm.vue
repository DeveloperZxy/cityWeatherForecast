  ...
  <div>
    <el-dialog v-model="dialogShow" :title="title">
      <el-form
        ...
        label-width="80px"
      >
        <el-form-item label="所属组织" prop="categoryId" style="width: 650px">
          <el-tree-select
        ...
        <el-form-item label="岗位" prop="position">
          <SystemDictSelect
            ...
            dict-code="Emp.Position"
          />
        </el-form-item>
        <el-form-item label="角色" prop="role">
          <SystemDictSelect v-model="formData.role" dict-code="Emp.Role" />
        </el-form-item>
...
import {
  ...
  getEditApi,
  getShowApi
} from "@/api/info/admin/adminInfoApi";
...
const getTree = async () => {
  const res = await adminCategoryApi.getTreeApi({});
...
const open = async (type: string, id?: any, categoryId?: any) => {
  ...
  let response = await adminCategoryApi.getListApi({ includeRoot: "0" });
