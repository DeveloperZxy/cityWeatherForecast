/*
 ...
 Source Schema         : db_artical

 Target Server Type    : MySQL
 Target Server Version : 90001 (9.0.1)
 File Encoding         : 65001

 Date: 24/04/2025 09:27:49
*/
...
-- ----------------------------
INSERT INTO `crm_user_info` VALUES (1, '1898711866655313921', NULL, '2025-03-29 14:57:35', '2025-03-31 13:57:19', '管理员', 0, NULL, NULL, NULL, NULL, NULL, 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '阿达额分', 'e10adc3949ba59abbe56e057f20f883e', '[\"1905254920082030594\", \"1905255465828089858\"]', 0);
...
INSERT INTO `crm_user_info` VALUES (1904826326545473537, '1898711903900733442', '', '2025-03-26 17:22:40', '2025-03-31 13:57:07', 'ccc', 1, '22', NULL, NULL, '', '速度非常', 'ccc', NULL, '124435543', '', NULL, NULL, NULL, NULL, 0x3132343434343635, NULL, '2025-03-08 08:00:00', '阿达额分', '123456e10adc3949ba59abbe56e057f20f883e', '[]', 0);
...
CREATE TABLE `product_brand`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `category_id`(`category_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1904779143620284418 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product_brand
-- ----------------------------
INSERT INTO `product_brand` VALUES (0, '-1', NULL, '2025-03-11 15:50:44', '2025-03-11 16:09:23', '全部', 1, NULL, NULL, NULL, NULL, NULL, NULL, '[\"-1\"]', '1', 0);
...
CREATE TABLE `product_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `category_id`(`category_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1899368555754803203 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product_category
-- ----------------------------
INSERT INTO `product_category` VALUES (0, '-1', NULL, '2025-03-11 15:50:44', '2025-03-14 11:56:18', '全部', 1, NULL, NULL, NULL, NULL, NULL, 'https://img.zcool.cn/community/01102b61086ea011013eaf709d8900.jpg?x-oss-process=image/auto-orient,1/resize,m_lfit,w_1280,limit_1/sharpen,100', '[\"-1\"]', '1', 0);
...
CREATE TABLE `system_permission_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `category_id`(`category_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1905982966867103746 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of system_permission_info
-- ----------------------------
INSERT INTO `system_permission_info` VALUES (0, '-1', NULL, '2025-03-11 15:50:44', '2025-03-16 13:11:05', '全部', 1, NULL, NULL, NULL, NULL, NULL, NULL, '[\"-1\"]', NULL, NULL, NULL, NULL, 0);
