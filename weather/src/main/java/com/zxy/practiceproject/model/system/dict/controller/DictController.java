package com.zxy.practiceproject.model.system.dict.controller;
...
import com.zxy.practiceproject.model.system.dict.pojo.dto.CodeDTO;
...
public class DictController {
    ...
    public Result<List<DictEntity>> listByCode(@RequestBody CodeDTO codeDTO){
        List<DictEntity> list = configService.listByCode(codeDTO.getCode());
